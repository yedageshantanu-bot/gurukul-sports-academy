  ...
  async getActiveTemplateForEvent(eventType: WhatsAppEventType) {
    ...
    const defaultTemplates: Record<string, any> = {
      ...
      FEE_DUE: {
        ...
        event_type: 'FEE_DUE',
        body: 'Dear {{parent_name}}, fee of ₹{{amount}} for {{student_name}} at {{academy_name}} is due on {{due_date}}.\n\n💬 Kindly reply "OK" or settle dues at your convenience.\n📌 Save this number as {{academy_name}}.',
        active: true,
      },
      FEE_OVERDUE: {
        ...
        body: 'Dear {{parent_name}}, fee of ₹{{amount}} for {{student_name}} at {{academy_name}} is now OVERDUE since {{due_date}}.\n\n💬 Kindly reply to this message if you have already paid or need assistance.\n📌 {{academy_name}}',
        active: true,
      },
      PAYMENT_SUCCESS: {
